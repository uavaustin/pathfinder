...
fn main() {
    ...
    let mut waypoints = LinkedList::new();
    waypoints.push_back(
        Waypoint::new(0, Point::from_degrees(30.322280883789063, -97.60298156738281, 100f32), 10f32)
    );
    waypoints.push_back(
        Waypoint::new(1, Point::from_degrees(30.322280883789063, -97.60098266601564, 150f32), 10f32)
    );
