...
pub struct TestMessage {
    // message fields
    pub information: ::std::string::String,
    // special fields
...
impl TestMessage {
    ...
    pub fn set_information(&mut self, v: ::std::string::String) {
        self.information = v;
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_information(&mut self) -> &mut ::std::string::String {
        &mut self.information
    }

    // Take field
    pub fn take_information(&mut self) -> ::std::string::String {
        ::std::mem::replace(&mut self.information, ::std::string::String::new())
    }
}
...
impl ::protobuf::Message for TestMessage {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                1 => {
                    ::protobuf::rt::read_singular_proto3_string_into(wire_type, is, &mut self.information)?;
                },
                _ => {
    ...
    fn compute_size(&self) -> u32 {
        ...
        if !self.information.is_empty() {
            my_size += ::protobuf::rt::string_size(1, &self.information);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        if !self.information.is_empty() {
            os.write_string(1, &self.information)?;
        }
        ...
        unsafe {
            descriptor.get(|| {
                ...
                fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeString>(
                    "information",
                    |m: &TestMessage| { &m.information },
                    |m: &mut TestMessage| { &mut m.information },
                ));
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\rservice.proto\x12\npathfinder\"/\n\x0bTestMessage\x12\x20\n\x0binfor\
    mation\x18\x01\x20\x01(\tR\x0binformationb\x06proto3\
";
